...
export const AboutPage: React.FC<AboutPageProps> = ({ onOpenBooking, onNavigate }) => {
  const { businessInfo, activeStylists } = useSalon();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-sm sm:text-base text-[#4A4A4A] font-light leading-relaxed">
            Located in International City Phase 2 (Warsan 4), {businessInfo.name} was established to deliver Dubai’s gentlemen a high-caliber grooming experience combining master craftsmanship with modern spa relaxation.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 overflow-hidden shadow-2xl border border-[#E5E1DA] h-[420px] sm:h-[500px] relative bg-white">
            ...
            <div className="absolute bottom-6 left-6 right-6 text-white p-5 bg-[#121212]/85 backdrop-blur-md border border-white/15">
              ...
              <p className="font-serif text-lg font-light">
                {businessInfo.address} — modern barber stations, sterile tools &amp; late evening hours until midnight.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-10">
            <div className="text-center max-w-2xl mx-auto space-y-3">
              ...
              <p className="text-sm text-[#4A4A4A] font-light">
                Each artist at {businessInfo.name} brings over a decade of specialized expertise in men's haircutting, beard sculpting, and aesthetic care.
              </p>
            </div>
        ...
        <div className="p-8 sm:p-12 bg-white border border-[#E5E1DA] text-center max-w-3xl mx-auto space-y-6 shadow-xs">
          ...
          <p className="text-sm text-[#4A4A4A] font-light max-w-md mx-auto">
            Book online instantly or walk into our salon in {businessInfo.shortLocation}. Open daily until {businessInfo.closingTime || '12:00 AM midnight'}.
          </p>
